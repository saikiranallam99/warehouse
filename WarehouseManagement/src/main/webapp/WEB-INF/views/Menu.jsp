...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark ">
    ...
    <li class="nav-item">
      <a class="nav-link" href="#">Link 2</a>
        ...
        <a class="dropdown-item" href="${url}/ordermethod/getAll">View All</a>
        ...
        <a class="dropdown-item" href="${url}/shipmenttype/getAll">View All</a>
        ...
        <a class="dropdown-item" href="${url}/whusertype/viewAll">View All</a>
        ...
        <a class="dropdown-item" href="${url}/item/getAll">View All</a>
